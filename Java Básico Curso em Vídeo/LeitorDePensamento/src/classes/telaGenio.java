...
public class telaGenio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblFrase, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 40, 150, 50));
        ...
        getContentPane().add(txtVal, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 170, -1, -1));
        ...
        getContentPane().add(btnPalpite, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 240, -1, -1));
    ...
    private void btnPalpiteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPalpiteActionPerformed
        ...
        int usuario = Integer.parseInt(txtVal.getValue().toString());
        
        String frase1 = "<html><strong>Acertou!</strong></html>";
        String frase2 = "<html>Errou! Eu pensei no valor " + valor + "</html";
        
        String resultado = (usuario == valor)? frase1:frase2;
